...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-03-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-03-trainhist.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_03.pkl'), 'rb') as f:
...
with tf.device('/gpu:0'):
    ...
    f2 = Convolution2D(32, 3, 3, init='he_uniform', border_mode='same', activation='relu', dim_ordering='tf')(f2)
    ...
    f4 = Convolution2D(32, 3, 3, init='he_uniform', border_mode='same', activation='relu', dim_ordering='tf')(f4)
...
with tf.device('/gpu:1'):
    ...
    f8 = Convolution2D(32, 3, 3, init='he_uniform', border_mode='same', activation='relu', dim_ordering='tf')(f8)
    ...
    f16 = Convolution2D(32, 3, 3, init='he_uniform', border_mode='same', activation='relu', dim_ordering='tf')(f16)
