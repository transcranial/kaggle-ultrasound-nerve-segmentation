...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15c-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15c-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15c.pkl'), 'rb') as f:
