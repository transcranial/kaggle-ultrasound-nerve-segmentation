...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-segment-17b-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-segment-17b-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_segment_17b.pkl'), 'rb') as f:
