...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15b-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15b-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15b.pkl'), 'rb') as f:
