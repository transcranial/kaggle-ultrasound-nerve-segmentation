...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-segment-18a-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-segment-18a-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_segment_18a.pkl'), 'rb') as f:
