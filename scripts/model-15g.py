...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15g-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15g-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15g.pkl'), 'rb') as f:
