...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15a-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15a-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15a.pkl'), 'rb') as f:
