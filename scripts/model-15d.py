...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15d-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15d-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15d.pkl'), 'rb') as f:
