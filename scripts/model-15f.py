...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15f-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15f-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15f.pkl'), 'rb') as f:
