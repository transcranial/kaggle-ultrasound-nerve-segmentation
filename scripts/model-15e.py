...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-15e-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-15e-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_15e.pkl'), 'rb') as f:
