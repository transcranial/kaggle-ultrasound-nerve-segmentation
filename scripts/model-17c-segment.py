...
WEIGHTS_FILEPATH = os.path.join(MODELDIR, 'model-segment-17c-weights.hdf5')
HISTORY_FILEPATH = os.path.join(MODELDIR, 'model-segment-17c-history.json')

#############################################################################
# LOAD DATA

with open(os.path.join(PROCDIR, 'data_train_val_segment_17c.pkl'), 'rb') as f:
